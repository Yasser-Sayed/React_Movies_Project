...
function Register(){
    ...
    <main className="form-signin  m-auto mt-5 col-xl-4 col-md-5 col-sm-7 col-xs-7 text-light"  >
        <form className="border rounded" style={{fontSize: "14px"}} >
          ...
          <button className="ms-3 col-11 btn btn-sm btn-warning"  type="submit">Continue</button>
          <p className="m-3 text-muted smallfont">By creating account, you agree to <a href="/#">Amazon's Conditions of Use</a> and <a href="/#">Privacy Notice.</a></p>
